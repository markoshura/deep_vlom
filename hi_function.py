...
def hi(T, rho):
    ...
    def sigma_2(sigma_0,sigma_1):
        return sigma_1 - (sigma_1-sigma_0)*hi_function(sigma_1, T, rho)/(hi_function(sigma_1, T, rho) - hi_function(sigma_0, T, rho))

    sigma_2 = sigma_2(1,-1)
    print(sigma_2)

    return (hi_function(sigma_2, T, rho))
